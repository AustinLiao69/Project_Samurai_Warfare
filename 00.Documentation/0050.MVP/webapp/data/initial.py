...
INITIAL_STATE = {
    ...
    # ── 武將 ─────────────────────────────────────────────────
    # eval 鍵名對應 0011.武將評價模組：軍事/智謀/政治/魅力
    "retainers": [
        # ────── 織田家・大名 ──────
        {
        ...
        },
        {
            ...
            "eval": {"軍事": ("C","嶄露頭角"), "智謀": ("C","聰明機智"),
                     "政治": ("A","治國之能臣"), "魅力": ("B","人望漸隆")},
        },
        # ────── 織田家・家老 ──────
        {
        ...
        },
        {
            ...
            "eval": {"軍事": ("C","嶄露頭角"), "智謀": ("A","謀略過人"),
                     "政治": ("A","治國之能臣"), "魅力": ("A","呼風喚雨")},
        },
        {
            ...
            "eval": {"軍事": ("A","名將之風"), "智謀": ("B","奇謀之將"),
                     "政治": ("C","能幹之材"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "morikatsunari", "name": "森可成", "faction": "oda",
            "rank": "家老", "lineage": "外樣", "loyalty": 72,
            "loyalty_label": "忠心耿耿", "forces": 1500, "location": "castle_01", "corps_id": None,
            "mil": 87, "str_": 75, "pol": 49, "cha": 67,
            "eval": {"軍事": ("S","無敵猛將"), "智謀": ("A","名將之風"),
                     "政治": ("C","能幹之材"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "ikedatsuneyoshi", "name": "池田恒興", "faction": "oda",
            "rank": "家老", "lineage": "一門", "loyalty": 80,
            "loyalty_label": "忠心耿耿", "forces": 1200, "location": "castle_01", "corps_id": None,
            "mil": 72, "str_": 73, "pol": 63, "cha": 63,
            "eval": {"軍事": ("A","名將之風"), "智謀": ("A","名將之風"),
                     "政治": ("B","為政清明"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "inabaittetsu", "name": "稻葉一鐵", "faction": "oda",
            "rank": "家老", "lineage": "外樣", "loyalty": 65,
            "loyalty_label": "表面恭敬", "forces": 1000, "location": "castle_03", "corps_id": None,
            "mil": 71, "str_": 77, "pol": 71, "cha": 78,
            "eval": {"軍事": ("A","名將之風"), "智謀": ("A","名將之風"),
                     "政治": ("A","治國之能臣"), "魅力": ("A","呼風喚雨")},
        },
        # ────── 織田家・部將 ──────
        ...
        {
            "id": "sakaimasahisa", "name": "坂井政尚", "faction": "oda",
            "rank": "部將", "lineage": "譜代", "loyalty": 76,
            "loyalty_label": "忠心耿耿", "forces": 800, "location": "castle_01", "corps_id": None,
            "mil": 82, "str_": 73, "pol": 61, "cha": 32,
            "eval": {"軍事": ("A","名將之風"), "智謀": ("A","名將之風"),
                     "政治": ("B","為政清明"), "魅力": ("D","平庸無奇")},
        },
        {
            "id": "okamotoyoshikatsu", "name": "岡本良勝", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 62,
            "loyalty_label": "表面恭敬", "forces": 500, "location": "castle_03", "corps_id": None,
            "mil": 48, "str_": 63, "pol": 56, "cha": 53,
            "eval": {"軍事": ("C","嶄露頭角"), "智謀": ("B","頗有勇名"),
                     "政治": ("B","為政清明"), "魅力": ("C","巧舌如簧")},
        },
        {
            "id": "mizunotadashige", "name": "水野忠重", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 65,
            "loyalty_label": "表面恭敬", "forces": 400, "location": "castle_04", "corps_id": None,
            "mil": 41, "str_": 51, "pol": 59, "cha": 65,
            "eval": {"軍事": ("C","嶄露頭角"), "智謀": ("C","聰明機智"),
                     "政治": ("B","為政清明"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "asanonagamasa", "name": "淺野長政", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 65,
            "loyalty_label": "表面恭敬", "forces": 400, "location": "castle_02", "corps_id": None,
            "mil": 44, "str_": 48, "pol": 75, "cha": 64,
            "eval": {"軍事": ("C","嶄露頭角"), "智謀": ("C","聰明機智"),
                     "政治": ("A","治國之能臣"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "muraitasada", "name": "村井貞勝", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 70,
            "loyalty_label": "表面恭敬", "forces": 200, "location": "castle_01", "corps_id": None,
            "mil": 33, "str_": 27, "pol": 91, "cha": 73,
            "eval": {"軍事": ("D","稍通軍事"), "智謀": ("D","略有小計"),
                     "政治": ("S","天下文臣之宗"), "魅力": ("A","呼風喚雨")},
        },
        {
            "id": "kanemorinagachika", "name": "金森長近", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 65,
            "loyalty_label": "表面恭敬", "forces": 600, "location": "castle_02", "corps_id": None,
            "mil": 60, "str_": 68, "pol": 65, "cha": 55,
            "eval": {"軍事": ("B","頗有勇名"), "智謀": ("B","頗有勇名"),
                     "政治": ("B","為政清明"), "魅力": ("B","人望漸隆")},
        },
        {
            "id": "gamoyoshikatsu", "name": "蒲生賢秀", "faction": "oda",
            "rank": "部將", "lineage": "外樣", "loyalty": 60,
            "loyalty_label": "表面恭敬", "forces": 500, "location": "castle_02", "corps_id": None,
            "mil": 58, "str_": 52, "pol": 66, "cha": 55,
            "eval": {"軍事": ("B","頗有勇名"), "智謀": ("C","嶄露頭角"),
                     "政治": ("B","為政清明"), "魅力": ("B","人望漸隆")},
        },
        # ────── 今川家 ──────
        {
